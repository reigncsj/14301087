...
public class Request implements ServletRequest{
	  ...
	  private String uri;
	  private Map<String,Object> al1;
	    
	  public Request(InputStream input) {  
	          
	          this.input = input;  
	          al1=new HashMap<String,Object>();
	      }  
	      ...
	      private void setAttribute(String[] att){
	    	  for(int i=0;i<att.length;i++){
	    		  al1.put(att[i].substring(0, att[i].indexOf("=")),att[i].substring(att[i].indexOf("=")+1));
	    	  }
	      }
